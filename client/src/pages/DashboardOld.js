...
const Dashboard = () => {
  ...
  // Handler for creating a team request (to be replaced with backend integration)
  ...
  return (
    <div className="h-screen flex bg-gray-100">
      ...
      {/* {showAIChatbotModal && <AIChatbotModal onClose={() => setShowAIChatbotModal(false)} />} */}
      {/* {showSupervisorSearchModal && <SupervisorSearchModal onClose={() => setShowSupervisorSearchModal(false)} />} */}
    </div>
  );
};
